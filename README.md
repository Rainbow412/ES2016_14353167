...
![../configure][5]
 ...
 - 进行测试
  a. 编写hello.h文件  （这里的路径是：/home/rainbow/Workspace/systemC_tb）
  ...
  c. 编写Makefile (下方的/home/rainbow/apps/libs/systemc-2.3.1为配置的SystemC路径) [LIB_DIR，INC_DIR都是上述make过程生成的东西]
